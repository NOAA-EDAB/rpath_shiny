...
# Gulf of Maine (modified EMAX version commented out June 2023)
...
ui <- fluidPage(
   ...
   sidebarLayout(
     sidebarPanel(
       helpText("App by G. Fay and S. Gaichas, Rpath by Sean Lucey, Gulf of Maine model by Sarah Weisberg"),
       ...
       conditionalPanel(condition = "input.model == 'Gulf of Maine'",
                        ...
                        sliderInput("hrateFishery",
                                    ...
                                    value = 1,
                                    step = 0.2),
                        # sliderInput("hrateFixed",
                        #             "Relative Fixed gear fleet fishing effort:",
                        #             min = 0,
                        #             max = 5,
                        #             value = 1,
                        #             step = 0.2),
                        # sliderInput("hrateHMS",
                        #             "Relative Tuna/Billfish/Shark fleet fishing effort:",
                        #             min = 0,
                        #             max = 5,
                        #             value = 1,
                        #             step = 0.2),
...
server <- function(input, output) {
   ...
   output$bioplot <- renderPlot({
     ...
     if(input$model == "Gulf of Maine"){
       ...
       #Change squid mort 
       GOM.b2 <- adjust.forcing(GOM.b2, parameter = 'ForcedMort', group = 'Loligo',
                                value = input$squidZ, sim.year = 25:100)
       #Change anadromous mort 
       GOM.b2 <- adjust.forcing(GOM.b2, parameter = 'ForcedMort', group = 'RiverHerring',
                                value = input$anadZ, sim.year = 25:100)
       #Change otherpelagics mort 
       GOM.b2 <- adjust.forcing(GOM.b2, parameter = 'ForcedMort', group = 'SmPelagics',
